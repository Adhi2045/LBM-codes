...
!    REAL(8),PARAMETER :: b = R/32.d0 ! new added
    ...
    REAL(8),PARAMETER :: Sigma = 0.0001285d0
    REAL(8),PARAMETER :: gY = 3.05e-5
    REAL(8),PARAMETER :: pai = 3.141592653589793d0 ! added value of pai

    REAL(8),PARAMETER :: tau_H = 0.6968d0 !0.8d0 !0.3d0 + 0.5d0 !(3.d0*U0*real(Nx))/Re mu was taken 0.005
    REAL(8),PARAMETER :: tau_L = 2.468d0  !0.8d0  !0.3d0 + 0.5d0 !(3.d0*U0*real(Nx))/Re !10.d0*(3.d0*U0*real(Nx))/Re
