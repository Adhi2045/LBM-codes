...
MODULE SHARE
    ...
    REAL(8),PARAMETER :: R = 50 !L0/8.d0 ! original
...
!    REAL(8),PARAMETER :: b = R/32.d0 ! new added
    ...
    REAL(8),PARAMETER :: tau_H = 0.575d0 !0.8d0 !0.3d0 + 0.5d0 !(3.d0*U0*real(Nx))/Re mu was taken 0.005
    REAL(8),PARAMETER :: tau_L = 1.25d0  !0.8d0  !0.3d0 + 0.5d0 !(3.d0*U0*real(Nx))/Re !10.d0*(3.d0*U0*real(Nx))/Re
